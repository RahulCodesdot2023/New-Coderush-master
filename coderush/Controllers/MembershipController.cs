...
namespace coderush.Controllers
{
    ...
    public class MembershipController : Controller
    {
        ...
        public async Task<IActionResult> SubmitChangeProfile([Bind("Id,EmailConfirmed,Email,FirstName,LastName,PhoneNumber,JoiningDate,ProfilePicture, Salary")] ApplicationViewModel applicationUser)
        {
            try
            {
                ...
                updatedUser.DOB = applicationUser.DOB;
                updatedUser.Salary = (int)applicationUser.Salary;
