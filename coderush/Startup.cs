...
namespace coderush
{
    public class Startup
    {
        ...
        public async void Configure(IApplicationBuilder app, IWebHostEnvironment env, Services.Database.ICommon dbInit)
        {
            ...
            //{
            //    builder.MapHub<BirthdayNotificationHub>("birthdayNotificationHub");
            //});
            ...
            await SeedData.SeedEmployeeManagementAsync();


            app.UseSignalR(routes =>
            {
                routes.MapHub<BirthdayNotificationHub>("/birthdayNotificationHub");
