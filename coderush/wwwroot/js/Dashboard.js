$(document).ready(function () {
            ...
            success: function (data) {
                ...
                if (data.list != null && data.list.length > 0) {
                    ...
                    $.each(data.list, function (i, v) {
                        ...
                        innerHtml += "<td scope='col' id='To Date'>" + moment(rowdata.todate).format('LL') + "</td>";
                        innerHtml += "<td scope='col' id='Count'>" + rowdata.count + "</td>";
                        innerHtml += "<td scope='col' id='Description' class='table-description'>" + rowdata.employeeDescription + "</td>";
                        if (isSuperAdmin == 'True' || isHR == 'True') {
                            innerHtml += "<td scope='col' id='hrDescription'>" + rowdata.hrDescription + "</td>";
                        }
    ...
    function gridSorting() {
        $(".grid1").dataTable({
            aaSorting: [[2, 'asc']],
            bPaginate: true,
            iDisplayLength: 10, // Number of rows to display per page
            bFilter: false,
            bInfo: false,
            bSortable: true,
            bRetrieve: true,
